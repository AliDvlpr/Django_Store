...
class Product(models.Model):
    title = models.CharField(max_length=255)
    slug = models.SlugField()
    guarantee_type = models.CharField(max_length=255, null=True, blank=True)
    description = models.TextField(null=True, blank=True)
...
class ProductPowers(models.Model):
    Product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name="powers")
    UNIT_KW1450 = 'KW1450'
    UNIT_HP1450 = 'HP1450'
    UNIT_KW2900 = 'KW2900'
    UNIT_HP2900 = 'HP2900'
    ...
    unit = models.CharField(
        max_length=6, choices=UNIT_CHOICES, default=UNIT_KW1450)
